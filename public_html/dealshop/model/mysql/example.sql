-- Directions 
-- Create the guitar2 database in the hosting environment
-- Assign the iClient user to the guitar2 database with Select, Insert, Update and Delete privileges
-- Using PHPMyAdmin, import this file into the guitar2 database to create the tables and data
-- Use this same file to restore the tables to their original state if needed

-- Drops existing tables prior to creating or recreating the tables
DROP TABLE IF EXISTS customers, addresses, orders, orderItems, products, categories, administrators;
